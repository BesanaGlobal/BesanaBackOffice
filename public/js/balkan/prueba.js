window.onload = function () {
    ...
    var expandAllIcon = '<svg class="shadow" width="64" height="64" fill="#9b0000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"' +
    ...
    var csvIcon = '<svg width="35" height="35"version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"' +
      ...
      OrgChart.templates.myTemplate.node  = '<circle cx="100" cy="100" r="100" fill="#ff0000" stroke-width="1" stroke="#aeaeae"></circle>';
      ...
      OrgChart.templates.myTemplate.field_0         = '<text width="210" class="field_0" style="font-size: 25px;" fill="#ffffff" x="80" y="30" text-anchor="start" dominant-baseline="central">{val}</text>';
      OrgChart.templates.myTemplate.field_1         = '<text width="210" class="field_1" style="font-size: 25px;" fill="#ffffff" x="80" y="55" text-anchor="start" dominant-baseline="central">{val}</text>';
      ...
      OrgChart.templates.sociopromotor              = Object.assign({}, OrgChart.templates.myTemplate);
      OrgChart.templates.sociopromotor.node         = '<rect x="0" y="0" height="80" width="300" fill="red" stroke-width="1" stroke="#aeaeae" rx="40" ry="40"></rect>';

      OrgChart.templates.asociado                   = Object.assign({}, OrgChart.templates.myTemplate);
      OrgChart.templates.asociado.node              = '<rect x="0" y="0" height="80" width="300" fill="#008000" stroke-width="1" stroke="#aeaeae" rx="40" ry="40"></rect>' ;
      ...
      OrgChart.templates.jade                       = Object.assign({}, OrgChart.templates.myTemplate);
      OrgChart.templates.jade.node                  = '<rect x="0" y="0" height="80" width="300" fill="#008000" stroke-width="1" stroke="#aeaeae" rx="40" ry="40"></rect>';

      OrgChart.templates.safiro                     = Object.assign({}, OrgChart.templates.myTemplate);
      OrgChart.templates.safiro.node                = '<rect x="0" y="0" height="80" width="300" fill="#008000" stroke-width="1" stroke="#aeaeae" rx="40" ry="40"></rect>' ;
    
      OrgChart.templates.safiroazul                 = Object.assign({}, OrgChart.templates.myTemplate);
      OrgChart.templates.safiroazul.node            = '<rect x="0" y="0" height="80" width="300" fill="#008000" stroke-width="1" stroke="#aeaeae" rx="40" ry="40"></rect>';

      OrgChart.templates.rubi                       = Object.assign({}, OrgChart.templates.myTemplate);
      OrgChart.templates.rubi.node                  = '<rect x="0" y="0" height="80" width="300" fill="#008000" stroke-width="1" stroke="#aeaeae" rx="40" ry="40"></rect>' ;
    
      OrgChart.templates.esmeralda                  = Object.assign({}, OrgChart.templates.myTemplate);
      OrgChart.templates.esmeralda.node             = '<rect x="0" y="0" height="80" width="300" fill="#008000" stroke-width="1" stroke="#aeaeae" rx="40" ry="40"></rect>';

      OrgChart.templates.diamante                   = Object.assign({}, OrgChart.templates.myTemplate);
      OrgChart.templates.diamante.node              = '<rect x="0" y="0" height="80" width="300" fill="#008000" stroke-width="1" stroke="#aeaeae" rx="40" ry="40"></rect>' ;
    
      OrgChart.templates.diamanteazul               = Object.assign({}, OrgChart.templates.myTemplate);
      OrgChart.templates.diamanteazul.node          = '<rect x="0" y="0" height="80" width="300" fill="#008000" stroke-width="1" stroke="#aeaeae" rx="40" ry="40"></rect>' ;
    
      OrgChart.templates.diamantecorona             = Object.assign({}, OrgChart.templates.myTemplate);
      OrgChart.templates.diamantecorona.node        = '<rect x="0" y="0" height="80" width="300" fill="#008000" stroke-width="1" stroke="#aeaeae" rx="40" ry="40"></rect>' ;
      ...
      OrgChart.templates.besana.field_0             = '<text width="210" class="field_0" style="font-size: 25px;" fill="#757575" x="80" y="30" text-anchor="start" style="align:center" dominant-baseline="central">{val}</text>';
      OrgChart.templates.besana.field_1 = '<text width="210" class="field_1" style="font-size: 25px;" fill="#757575" x="80" y="55" text-anchor="start" style="align:center" dominant-baseline="central">{val}</text>';
      ...
      var chart = new OrgChart(document.getElementById("tree"), {
        ...
        tags: {
          ...
          diamanteazul:{
            template:"diamanteazul"
          },
          diamantecorona:{
            template:"diamantecorona"
          },
