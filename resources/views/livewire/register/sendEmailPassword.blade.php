                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:40px 50px 30px;font-family:'Raleway',sans-serif;" align="left">
                                                            ...
                                                            <div class="v-text-align" style="font-size: 14px; line-height: 160%; text-align: justify; word-wrap: break-word;">
                                                                ...
                                                                <p style="line-height: 160%; font-size: 14px;"> </p>
                                                                <div>
                                                                    <div>Hola, {{$Name}}, aqui te enviamos tu Usuario y una Contraseña nueva, con ella puedes entrar a tu perfil.</div>
                                                                    <div>Sigamos!.</div>
                                                                    <div> </div>
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Raleway',sans-serif;" align="left">
                                                            ...
                                                            <div class="v-text-align" align="center">
                                                                ...
                                                                <a href="https://backoffice.besanaglobal.com/login" target="_blank" class="v-button v-size-width v-border-radius" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #111ef7; border-radius: 25px;-webkit-border-radius: 25px; -moz-border-radius: 25px; width:30%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
                                                                    <span class="v-padding" style="display:block;padding:10px 20px;line-height:120%;"><strong><span style="font-size: 14px; line-height: 16.8px;">Ingresar</span></strong></span>
                                                                </a>
